...
abstract class AbstractRestfulRepository extends AbstractCudRepository
{
     ...
     */
    private function _addArrayOp(QueryBuilder $qb, ArrayCollection $expressions, ArrayCollection $values, ArrayCollection $types, $position, $property, $operator, array $value = null)
    {
        if (!isset($value)) {
     ...
     * @return int The updates position counter.
     */
    private function _addBinaryOp(QueryBuilder $qb, ArrayCollection $expressions, ArrayCollection $values, ArrayCollection $types, $position, $property, $operator, $value = null)
    {
        if (!isset($value)) {
            throw new \InvalidArgumentException('Missing \'value\' key in criteria array');
        }
